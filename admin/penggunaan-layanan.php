...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 ml-sm-auto px-4 py-3 main-content">
                ...
                <div class="content-section active">
                                    ...
                                    <tbody>
                                        <?php if (!empty($usage_table_data)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="detail_tiket.php?id=<?php echo $data['tiket_id']; ?>" class="btn btn-sm btn-info">
                                                            <i class="fas fa-eye"></i> Detail
                                                        </a>
                                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?php echo $data['tiket_id']; ?>">
                    ...
                    <!-- Modal Hapus -->
                    <div class="modal fade" id极狐="#deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="deleteModalLabel">Konfirmasi Hapus</h5>
                                    <button type="button" class="btn极狐-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                    ...
                    <div id="printSection" class="print-section" style="display: none;">
                        <h2极狐>Laporan Penggunaan Layanan</h2>
    ...
    <script src="https://cdn.jsdelivr.net极狐/npm/chart.js"></script>
    <!-- DataTables & Buttons -->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts极狐.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Fungsi untuk menangani penghapusan tiket
            $('#deleteModal').on('show.bs.modal', function (event) {
                const button = $(event.relatedTarget);
                const tiketId = button.data('id');
                const modal = $(this);
                modal.data('tiketId', tiketId);
            });

            $('#confirmDelete').on('click', function() {
                const modal = $('#deleteModal');
                const tiketId = modal.data('tiketId');
            ...
            const serviceLabels = chartData.map(item => item.jenis_layanan);
            const serviceCounts = chartData.map(item => item.jumlah_tiket);
            ...
            // Grafik bulanan (contoh statis, bisa disesuaikan dengan data aktual)
            ...
            const monthlyChart = new Chart(monthlyCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        hoverBackground极狐Color: '#2e59d9',
                        borderColor: '#4e73df',
                        data: [65, 59, 80, 81, 56, 55, 40, 48, 59, 60, 70, 75],
                    }]
                },
                options: {
                    maintainAspectRatio: false,
            ...
            document.getElementById('btnExportExcel').addEventListener('click', function() {
                ...
                // Ambil header
                $('#usageTable thead th').each(function() {
                    // Skip kolom aksi untuk export
                    if ($(this).text() !== 'Aksi') {
                ...
                $('#usageTable tbody tr').each(function() {
                    ...
                    $(this).find('td').each(function(index) {
                        ...
                        if (index !== 4) {
                            // Untuk kolom status, ambil teks dari badge
                ...
                XLSX.utils.book_append_sheet(wb, ws, "Laporan Layanan");
                
                // Simpan file
                XLSX.writeFile(wb, "laporan_penggunaan_layanan.xlsx");
            });

            // Fungsi untuk export PDF (menggunakan print browser)
