        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="user_services.php">Layanan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="user_tickets.php">Tiket Saya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="user_request.php">Ajukan Permintaan</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            <img src="https://ui-avatars.com/api/?name=User+Name&background=ffffff&color=1e4359&size=36" class="user-avatar me-2">
    ...
    <div class="hero-section mt-5 pt-5">
        <div class="container">
            <div class="hero-content animate__animated animate__fadeInUp">
                ...
                <h1 class="display-4 fw-bold mb-3">Dukungan Teknologi Terbaik untuk Akademisi</h1>
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="user_request.php" class="btn btn-light btn-lg"><i class="fas fa-plus-circle me-2"></i>Ajukan Permintaan</a>
                    <a href="user_services.php" class="btn btn-outline-light btn-lg"><i class="fas fa-concierge-bell me-2"></i>Lihat Layanan</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#jaringan" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#software" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#hardware" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#akun" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#data" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-card card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="user_services.php#lainnya" class="btn btn-outline-primary mt-3">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="user_tickets.php" class="btn btn-outline-primary">Lihat Semua <i class="fas fa-arrow-right ms-2"></i></a>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-bold">#TK20230001</td>
                                    <td>Permintaan Akses WiFi</td>
                                    <td>15 Agu 2023</td>
                                    <td><span class="badge bg-success status-badge">Selesai</span></td>
                                    <td class="text-end"><a href="user_ticket_detail.php?id=1" class="btn btn-sm btn-outline-primary">Detail</a></td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">#TK20230025</td>
                                    <td>Instalasi Software SPSS</td>
                                    <td>22 Sep 2023</td>
                                    <td><span class="badge bg-warning text-dark status-badge">Proses</span></td>
                                    <td class="text-end"><a href="user_ticket_detail.php?id=25" class="btn btn-sm btn-outline-primary">Detail</a></td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">#TK20230042</td>
                                    <td>Permintaan Data Mahasiswa</td>
                                    <td>05 Okt 2023</td>
                                    <td><span class="badge bg-primary status-badge">Ditugaskan</span></td>
                                    <td class="text-end"><a href="user_ticket_detail.php?id=42" class="btn btn-sm btn-outline-primary">Detail</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 mb-4">
                    ...
                    <a href="user_dashboard.php" class="footer-link">Beranda</a>
                    <a href="user_services.php" class="footer-link">Layanan</a>
                    <a href="user_tickets.php" class="footer-link">Tiket Saya</a>
                    <a href="user_request.php" class="footer-link">Ajukan Permintaan</a>
                </div>
